...
(1, 'admin', 'admin@admin.admin', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '', '26,25,24,,,15,15,12,13,2,4,1,5,', 98360),
(2, 'user', 'user@user.user', 'user', '04f8996da763b7a969b1028ee3007569eaf3a635486ddab211d512c85b9df8fb', ',6,8', '10,16,5,', 150),
(13, 'user1', 'user1@user1.com', 'user', '0a041b9462caa4a31bac3567e0b6e6fd9100787db2ab433d96f6d178cabfce90', NULL, NULL, 0);
...
(21, 'action', 2023, 'Le Loup de Wall Street', 'Martin Scorsese', 'Leonardo DiCaprio, Jonah Hill, Margot Robbie', 'Jordan Belfort est un jeune trader ambitieux qui rêve de devenir riche. Il se lance dans le monde de la bourse et devient rapidement un trader hors pair. Mais il va vite se rendre compte que la bourse est un monde impitoyable et qu’il va devoir faire des sacrifices pour réussir.', 'https://image.tmdb.org/t/p/original/dQIQZbJXn1pflQw3nwvXLJX0dHa.jpg', 53, 'GT9UfSqBz9o', 'magie'),
