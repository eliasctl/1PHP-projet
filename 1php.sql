...
--
-- Hôte : localhost:3306
-- Généré le : mer. 15 mars 2023 à 23:30
...
VALUES
  (
    ...
    'Soleil vert',
    'Richard Fleischer',
    'Charlton Heston; Leigh Taylor-Young; Edward G. Robinson; Chuck Connors',
    ...
    'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSQJcQ-FngvFYcU_dFK41ZTkZnRaNuGCGUHotChejRrPWR-Da_v',
    3,
    '0LcT6D2kqJM',
    'pari'
  ),
  (
    ...
    'Andrew Stanton',
    'WALL-E; EVE',
    'Wall E, un petit robot, est le dernier être sur Terre ! 700 ans plus tôt, l\'humanité a déserté notre planète en lui laissant le soin de nettoyer la Terre. Mais Wall E a développé un petit défaut technique : une forte personnalité ! Curieux et indiscret, il est surtout très seul. Sa vie va être bouleversée avec l\'arrivée d\'Eve, une petite robote. Wall E va tout mettre en uvre pour la séduire.',
    'https://images-na.ssl-images-amazon.com/images/S/pv-target-images/4c8b6c0f9b929fa057f14048c20ffb2047ed3a55761de22b21d9f4ac3eff1d92._RI_V_TTW_.jpg',
    4,
    'twS3hYLmQI4',
    'dumb'
  ),
  (
    ...
    'https://fr.web.img4.acsta.net/medias/nmedia/18/36/20/29/18944269.jpg',
    5,
    'yt9r0Q5za38',
    'magie'
  ),
  ...
  (
    ...
    'Artemis Fowl',
    'Kenneth Branagh',
    'Ferdia Shaw; Colin Farrell; Josh Gad; Judi Dench',
    'À la suite de la mystérieuse disparition de son père, Artemis Fowl, 12 ans, découvre un journal qui l\'amène à croire que les histoires que lui racontait son paternel sur les fées et les nains sont réelles.',
    'https://fr.web.img2.acsta.net/pictures/20/04/17/15/29/2446287.jpg',
    12,
    'B-sd2YFyN0s',
    'dumb'
  ),
  (
    ...
    'Yves Robert',
    'André Treton; Michel Isella; Martin Lartigue; Michel Galabru; Jean Richard',
    ...
    'https://medias.unifrance.org/medias/202/123/97226/format_page/media.jpg',
    2,
    'KmsHWA7TZO0',
    'lapin'
  ),
  (
    ...
    'Philippe Labro',
    'Gérard Depardieu; Nathalie Baye; Carole Bouquet',
    ...
    'https://fr.web.img6.acsta.net/medias/nmedia/18/66/61/67/18944091.jpg',
    2,
    'eNrrP1M-TbM',
    'lapinx'
  ),
  (
    ...
    'T\'choupi',
    'Michel Fessler',
    'Gwénael Sommier; Clovis Mahouden; Héloïse Jadoul',
    'Accompagné de son extraordinaire confident Doudou, T\'choupi découvre avec émerveillement le petit village du bord de mer où il va habiter. Les beaux jours de l\'été, la plage, la liberté... Très vite, les vacances se révèlent riches en rencontres et en aventures.\r\n\r\nIl partage avec Doudou tous les événements de sa vie, où se mêlent joie et jalousie ; la famille s\'agrandit, T\'choupi a maintenant une petite soeur, Fanny. Mais une ombre mystérieuse trouble le bonheur des enfants du village en dérobant leurs jouets préférés. Avec Pilou et Lalou, ses nouveaux amis, T\'choupi va mener une enquête palpitante pour démasquer le coupable.\r\n',
    'https://fr.web.img6.acsta.net/c_310_420/medias/nmedia/18/35/20/57/18374973.jpg',
    3,
    'jMMpTCbjKTI',
    'magie'
  ),
  ...
  (
    ...
    'https://fr.web.img6.acsta.net/medias/nmedia/18/35/90/85/18798038.jpg',
    7,
    'pFhOBObXh9k',
    'pari'
  ),
  (
    ...
    'https://fr.web.img2.acsta.net/c_310_420/medias/nmedia/00/02/24/66/69198162_af.jpg',
    8,
    'ICglc80ZRho',
    'lapinx'
  ),
  (
    ...
    'Martin Brest',
    'Judge Reinhold, Judge Reinhold, John Ashton, Lisa Eilbacher, Ronny Cox',
    'Axel Foley, un policier désinvolte et indiscipliné de la ville de Détroit, vient de se faire réprimander par son patron pour avoir essayé d\'arrêter des trafiquants de cigarettes sans l\'avoir informé de son projet, ce qui a nui à son infiltration dans le réseau, faisant ainsi échouer sa mission non autorisée.',
    'https://www.themoviedb.org/t/p/w500/mZzoUerHfazvLfBO8e2eNNE4wHd.jpg',
    4,
    '1UV-lUZIyQk',
    'magie'
  ),
  (
    ...
    'Transformers',
    'Michael Bay',
    'Shia LaBeouf, Megan Fox, Peter Cullen, Josh Duhamel, Tyrese Gibson, Hugo Weaving',
    'À bord d\'Air Force One, un poste de radio se transforme en robot (Frenzy) et pirate un ordinateur mais le virus est aussitôt détecté par Maggie et son équipe.',
    'https://c8.alamy.com/zoomsfr/9/91c50b8df1cc4819a15aaf3436087c7c/pmb402.jpg',
    4,
    '_XKAU3tYO9M',
    'pari'
  ),
  (
    ...
    'https://cdn.unitycms.io/images/5iTuiuwo4nJ9OoCx-jqtYk.jpg',
    555,
    'i8sEGppZX-s',
    'lapin'
  ),
  (
    ...
    'https://images.affiches-et-posters.com//albums/3/58999/medium/poster-film-top-gun-maverick.jpg',
    666,
    'V4gQdk1nAn0',
    'dumb'
  ),
  (
    ...
    'Là-haut',
    'Pete Docter',
    'Charles Aznavour; Edward Asner; Tom Trouffier',
  ...
  (
    ...
    'https://www.themoviedb.org/t/p/original/51ghTkfKRttjOk01h3ye14JQFwY.jpg',
    11,
    '5mdzcxbZC4A',
    'lapin'
  ),
  (
    ...
    'https://www.themoviedb.org/t/p/original/3E53WEZJqP6aM84D8CckXx4pIHw.jpg',
    41,
    'XWtH7anz7io',
    'pari'
  ),
  (
    ...
    'https://www.themoviedb.org/t/p/original/3QsSKLq6yewtII9wx3yWVU92rxs.jpg',
    19,
    'kmXo1Ncy0aM',
    'dumb'
  ),
  (
    ...
    'https://fr.web.img6.acsta.net/pictures/23/02/06/09/28/4212244.jpg',
    26,
    'DAwm8ioRRuU',
    'lapinx'
  ),
  (
    ...
    'Jordan Belfort est un jeune trader ambitieux qui rêve de devenir riche. Il se lance dans le monde de la bourse et devient rapidement un trader hors pair. Mais il va vite se rendre compte que la bourse est un monde impitoyable et qu’il va devoir faire des sacrifices pour réussir.',
    'https://image.tmdb.org/t/p/original/dQIQZbJXn1pflQw3nwvXLJX0dHa.jpg',
    53,
    'GT9UfSqBz9o',
    'magie'
  ),
  ...
  (
    ...
    'Frodon et Sam poursuivent leur route vers Mordor pour détruire l’Anneau unique, tandis que Aragorn, Legolas et Gimli, aidés de Merry et Pippin, continuent à se battre pour le roi Théoden. Ensemble, ils doivent affronter l’armée de Sauron, commandée par le Nazgûl, et affronter le terrible Gollum.',
    'https://image.tmdb.org/t/p/original/4fcgHdNryRuvEpsldjYifFEVX2i.jpg',
    43,
    'nalLU8i4zgs',
    'magie'
  ),
  (
    ...
    'https://www.themoviedb.org/t/p/original/AfKm745YiKJ14yp4UfA4jowBIPi.jpg',
    9,
    '_NxDVVyxyjU',
    'dumb'
  ),
  (
    ...
    'Ted',
    'Seth MacFarlane',
    'Mark Wahlberg, Mila Kunis, JoeyStarr',
    ...
    'https://www.themoviedb.org/t/p/original/zdZKj5nqe3tEwuzEYbxAgMESFe7.jpg',
    35,
    '3NPVAUxspdc',
    'lapinx'
  ),
  (
    ...
    'https://www.themoviedb.org/t/p/original/kZ9cHlWbhtPx5IoR9R1n8UHozej.jpg',
    45,
    'Ewp9umK4V0E',
    'lapin'
  );
